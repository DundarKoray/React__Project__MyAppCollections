          ...
          <div className="about-me-wrapper">
            <div className="about-me-text">
              ...
              <p>
                ...
                technologies. Last year, I've attended a full-time web
                development course from 9-17 every-week days for a year. I've
                been creating projects using JS, React, Gatsby, D3.js, Firebase,
                Contentful and GraphQL. Here is my GitHub account and project
                titles down below are also clickable.
              </p>
              <p>
                I am a self motivated person who is everyday eagerly coding and
                learning more. I am looking for an opportunity where I am able
                to apply my current skills and improve my coding skills to a
                further degree.
              </p>
              <div>
                {/* <a
                ...
                <a
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://www.koray-dundar.com/en/"
                >
